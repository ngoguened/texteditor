...
class ModelTest(unittest.TestCase):
    ...
    def test_window(self):
        ...
        new_model=WindowedLines(filename="", window_size=(1,5))
        ...
        new_model=WindowedLines(window_size=(2,5), filename="tst.txt")
        for char in "Hello\nthere,\nWorld!":
            new_model.insert(char)
        assert new_model.top_window_row == 1, new_model.prev_lines
        new_model.up()
        ...
        new_model=WindowedLines(window_size=(10,5), filename="tst.txt")
        for char in "a\nb\nc\nd":
            new_model.insert(char)
        new_model.up()
        new_model.up()
        ...
        new_model=WindowedLines(window_size=(4,5), filename="tst.txt")
        for char in "a\nb\nc\nd\ne\nf\ng\nh\ni\nj\nk":
            new_model.insert(char)
        for _ in range(18):
            new_model.up()
    ...
    def test_mark(self):
        new_model=WindowedLines(filename="tst.txt")
        for char in "Hello\nthere,\nWorld!":
            new_model.insert(char)
